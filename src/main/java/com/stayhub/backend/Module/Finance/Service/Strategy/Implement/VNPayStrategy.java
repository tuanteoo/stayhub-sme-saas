package com.stayhub.backend.Module.Finance.Service.Strategy.Implement;
...
import com.stayhub.backend.Module.Finance.Service.Strategy.PaymentStrategy;
...
public class VNPayStrategy implements PaymentStrategy {
    ...
    public Map<String, String> processIpn(HttpServletRequest request) {
        ...
        try {
            ...
            log.error("Lá»—i IPN: {}", e.getMessage());
    ...
    @Override
    public String createBookingPaymentUrl(String bookingCode, HttpServletRequest request) {
    ...
    @Override
    public String createSubscriptionPaymentUrl(Long planId, Long hostId, HttpServletRequest request) {
    ...
    @Override
    public boolean refundTransaction(Payment originalPayment, BigDecimal refundAmount) {
        ...
        try {
            ...
            if (responseBody != null && "00".equals(responseBody.get("vnp_ResponseCode"))) {
                log.info("VNPay thực hiện hoàn tiền thành công: {}", originalPayment.getBooking().getBookingCode());
                return true;
            } else {
                log.error("VNPAY thực hiện hoàn tiền thất bại: {}", responseBody != null ? responseBody.get("vnp_Message") : "KhÃ´ng cÃ³ pháº£n há»“i");
                return false;
            }
        } catch (Exception e) {
    ...
    private Map<String, String> handleSubscriptionPayment(String orderCode, long vnpAmount, String vnp_ResponseCode) {
        ...
        try {
            ...
            response.put("RspCode", "99");
            response.put("Message", "Lỗi xử lý giao dịch: " + e.getMessage());
            return response;
        }
    }
