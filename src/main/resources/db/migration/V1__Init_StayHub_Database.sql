...
-- 5.1. Seed Categories (Các loại hình phổ biến ở Việt Nam)
INSERT INTO categories (name, slug, description) VALUES
('Homestay', 'homestay', 'Nhà dân địa phương, không gian ấm cúng'),
('Villa', 'villa', 'Biệt thự nguyên căn, riêng tư, sang trọng'),
('Căn hộ / Chung cư', 'can-ho', 'Căn hộ dịch vụ tiện nghi tại trung tâm thành phố'),
('Resort', 'resort', 'Khu nghỉ dưỡng với đầy đủ tiện ích cao cấp'),
('Glamping / Lều', 'glamping', 'Cắm trại sang chảnh hòa mình vào thiên nhiên');

-- 5.2. Seed Amenities (Các tiện ích cơ bản)
INSERT INTO amenities (name, type) VALUES
('Wifi miễn phí', 'BASIC'),
('Điều hòa nhiệt độ', 'BASIC'),
('Bếp nấu ăn', 'BASIC'),
('Máy giặt', 'BASIC'),
('Tủ lạnh', 'BASIC'),
('Hồ bơi riêng', 'OUTDOOR'),
('Sân BBQ', 'OUTDOOR'),
('Ban công / Sân thượng', 'OUTDOOR'),
('Bảo vệ 24/7', 'SAFETY'),
('Camera an ninh', 'SAFETY'),
('Ghế ăn dặm cho bé', 'FAMILY');
